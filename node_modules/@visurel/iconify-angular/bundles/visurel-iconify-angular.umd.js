(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@visurel/iconify-angular', ['exports', '@angular/core', '@angular/platform-browser'], factory) :
    (global = global || self, factory((global.visurel = global.visurel || {}, global.visurel['iconify-angular'] = {}), global.ng.core, global.ng.platformBrowser));
    ...
    var IconService = /** @class */ (function () {
        ...
        IconService.prototype.register = function (name, icon) {
            this.iconsByName[name] = icon;
        };
        IconService.prototype.registerAll = function (iconsByName) {
            Object.assign(this.iconsByName, iconsByName);
        };
        IconService.prototype.get = function (name) {
            var icon = this.iconsByName[name];
            if (!icon) {
    ...
    var SVG = /** @class */ (function () {
         ...
         */
        SVG.calculateDimension = function (size, ratio, precision) {
         ...
         * Get SVG attributes
         */
        SVG.prototype.getAttributes = function (props) {
            var item = this._icon;
         ...
         * Generate SVG
         */
        SVG.prototype.getSVG = function (attributes) {
    ...
    var IconDirective = /** @class */ (function () {
        ...
        IconDirective.prototype.updateIcon = function () {
            ...
            var svg = new SVG(normalize(icon));
    ...
    IconDirective.propDecorators = {
        icIcon: [{ type: i0.Input }],
        icon: [{ type: i0.Input }],
        color: [{ type: i0.Input }],
        inline: [{ type: i0.Input }, { type: i0.HostBinding, args: ['class.ic-inline',] }],
        box: [{ type: i0.Input }],
        size: [{ type: i0.Input }],
        width: [{ type: i0.Input }],
        ...
        iconHTML: [{ type: i0.HostBinding, args: ['innerHTML',] }]
    };
...
//# sourceMappingURL=visurel-iconify-angular.umd.js.map
